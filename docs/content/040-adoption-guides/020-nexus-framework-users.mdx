...
Note that there is a [separate migration guide](https://www.notion.so/prismaio/Migrating-from-Prisma-plugin-for-Nexus-Framework-to-Prisma-plugin-for-Nexus-Schema-a9cdc93b689044d99ee5d42d39e60e90) detailing how to go from the Prisma plugin for Nexus Framework to the Prisma plugin for Nexus schema.

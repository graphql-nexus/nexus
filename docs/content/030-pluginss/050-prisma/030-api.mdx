...
Only available within [`objectType`](/api/api-objecttype) definitions.
...
input M_UpdateInput {
  MFloatF: S_FieldUpdateOperationsInput
  MIntF: S_FieldUpdateOperationsInput
  MSF: S
...
This allows you to update the values of certain fields atomically.
